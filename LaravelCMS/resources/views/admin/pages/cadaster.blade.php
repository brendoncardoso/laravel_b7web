        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('pages_cadaster_post')}}" method="POST" class="form-horizontal">
                    @csrf
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" name="title" class="form-control" id="" placeholder="Título" value="{{old('title')}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-2 col-form-label">Texto:</label>
                                <div class="col-sm-12">
                                    <textarea class="form-control bodyfield" name="body" id="" cols="30" rows="10" placeholder="">{{old('body')}}</textarea>
                                </div>
                            </div>
                        </div>
